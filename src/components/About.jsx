...
const About = () => {
  return (
    <>
    <div>
      <div  className='border bg-gray-500 rounded-2xl p-2 mb-3'>
      <p className='bg-black border-transparent rounded-2xl p-3 mb-3'>Lee Byung-hun is a South Korean actor born on July 12, 1970, in Seoul, South Korea. 
      ...
      <div className='flex flex-row mx-auto  gap-3'>
        <div className='border bg-gray-500 rounded-2xl p-2'>
      ...
      <div className='border-transparent rounded-2xl bg-gray-500 p-4 mt-3'>
        <div className='flex justify-center'>        
          <p className='border-transparent mt-3 w-60 rounded-full flex justify-center p-2 bg-black mb-4'>Philanthropy and Personal Life</p>
        </div>
        <p  className='bg-black border-b rounded-2xl p-3'>Lee Byung-hun is also known for his philanthropic efforts, 
          supporting various charitable causes and organizations. In 
          his free time, he enjoys playing golf and reading. He was previously romantically linked with fellow <a href='https://en.wikipedia.org/wiki/All_In_(TV_series)' className='italic font-bold text-xl'>All In</a> lead <a href="https://en.wikipedia.org/wiki/Song_Hye-kyo" className='italic font-bold text-xl'>Song Hye-kyo</a> Song Hye-kyo beginning in the early-2000s. The relationship, 
          though kept completely low-key and rarely publicized, lasted fifteen months before they 
          split in mid-June 2004. Lee married actor <a href="https://en.wikipedia.org/wiki/Lee_Min-jung" className='italic font-bold text-xl'>Lee Min-jung</a> on August 10, 2013, 
